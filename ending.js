document.addEventListener("DOMContentLoaded", function() {
  ...
  var loveForURichmond = document.getElementById("loveForURichmond");
  fadeInOut(loveForURichmond, 1000, 8000);
  ...
  var urichmondText = document.getElementById("urichmondText");
  setTimeout(function() {
    urichmondText.style.display = "block";
    fadeInOut(urichmondText, 1000, 5000);
  }, 15000);
